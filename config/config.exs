...
config :phoenix_kit, BeamLab.PhoenixKitWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: BeamLab.PhoenixKitWeb.ErrorHTML, json: BeamLab.PhoenixKitWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: BeamLab.PhoenixKit.PubSub,
  live_view: [signing_salt: "dnuoJBxY"]
...
config :phoenix_kit, BeamLab.PhoenixKit.Mailer, adapter: Swoosh.Adapters.Local
