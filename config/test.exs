...
config :phoenix_kit, BeamLab.PhoenixKitWeb.Endpoint,
  ...
  secret_key_base: "n1+JUwVItg/0MUxvXTRli9HlUJ/oR86rZEu9cB8YbAuIkeNlQWAOCeY+fakYtXPk",
  server: false

# In test we don't send emails
config :phoenix_kit, BeamLab.PhoenixKit.Mailer, adapter: Swoosh.Adapters.Test
