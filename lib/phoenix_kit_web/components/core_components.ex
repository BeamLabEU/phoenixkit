defmodule BeamLab.PhoenixKitWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeamLab.PhoenixKitWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeamLab.PhoenixKitWeb.Gettext, "errors", msg, opts)
    end
  end
