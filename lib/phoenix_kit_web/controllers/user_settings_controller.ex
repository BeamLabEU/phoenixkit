defmodule BeamLab.PhoenixKitWeb.UserSettingsController do
  use BeamLab.PhoenixKitWeb, :controller

  alias BeamLab.PhoenixKit.Accounts
  alias BeamLab.PhoenixKitWeb.UserAuth

  import BeamLab.PhoenixKitWeb.UserAuth, only: [require_sudo_mode: 2]
  ...
  def update(conn, %{"action" => "update_email"} = params) do
    ...
    case Accounts.change_user_email(user, user_params) do
      %{valid?: true} = changeset ->
        ...
        |> redirect(to: "/phoenix_kit/settings")
  ...
  def update(conn, %{"action" => "update_password"} = params) do
    ...
    case Accounts.update_user_password(user, user_params) do
      {:ok, {user, _}} ->
        ...
        |> put_session(:user_return_to, "/phoenix_kit/settings")
