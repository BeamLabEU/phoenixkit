defmodule PhoenixKitWeb.UserAuth do
  ...
  the current_user:
      ...
      defmodule PhoenixKitWeb.PageLive do
        ...
        on_mount {PhoenixKitWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PhoenixKitWeb.UserAuth, :ensure_authenticated}] do
  ...
  @doc false
  def call(conn, :phoenix_kit_require_authenticated_user), do: require_authenticated_user(conn, [])
