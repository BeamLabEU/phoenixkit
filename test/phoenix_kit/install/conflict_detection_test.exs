defmodule PhoenixKit.Install.ConflictDetectionTest do
  ...
  describe "perform_comprehensive_analysis/2" do
    ...
    test "respects risk tolerance settings", %{igniter: igniter, test_dir: test_dir} do
      ...
      {:ok, low_analysis} = ConflictDetection.perform_comprehensive_analysis(igniter, low_risk_opts)
      {:ok, high_analysis} = ConflictDetection.perform_comprehensive_analysis(igniter, high_risk_opts)
  ...
  describe "maybe_generate_migration_strategy/3" do
    ...
    test "generates migration strategy for conflicts", %{igniter: igniter, overall_assessment: assessment, analyses: analyses} do
      opts = [generate_migration_strategy: true]
      
      result = ConflictDetection.maybe_generate_migration_strategy(igniter, assessment, analyses, opts)
    ...
    test "skips strategy generation when disabled", %{igniter: igniter, overall_assessment: assessment, analyses: analyses} do
