defmodule BeamLab.PhoenixKitWeb.UserAuthTest do
  use BeamLab.PhoenixKitWeb.ConnCase, async: true

  alias BeamLab.PhoenixKit.Accounts
  alias BeamLab.PhoenixKit.Accounts.Scope
  alias BeamLab.PhoenixKitWeb.UserAuth

  import BeamLab.PhoenixKit.AccountsFixtures

  @remember_me_cookie "_beam_lab/phoenix_kit_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BeamLab.PhoenixKitWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
